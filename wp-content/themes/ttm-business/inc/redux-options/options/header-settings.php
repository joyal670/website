...
return array(
	...
	'fields' => array(
		...
		array(
          'id'      	 	 => 'logotype',
          'type'     		 => 'radio',
          'title'    		 => esc_attr__('Logo type', 'ttm-business'), 
          'options' 		 => array( 
								'text' => esc_attr__('Logo as Text', 'ttm-business'), 
								'image' => esc_attr__('Logo as Image', 'ttm-business') 
							),
          'default'  		 => 'image',
        ),
		array(
			...
			'required'         => array(
				array( 'logotype', '=', 'image' ),
			),
		),
		array(
			'id'     		 => 'logotext',
			'type'    		 => 'text',
			'title'   		 => esc_attr__('Logo Text', 'ttm-business'),
			'default' 		 => 'TTM Business',
			'required'         => array(
				array( 'logotype', '=', 'text' ),
			),
		),
		array(
			'id'             => 'logo_font',
			'type'           => 'typography',
			'title'          => esc_html__( 'Logo Font', 'ttm-business' ),
			'google'         => true,
			'font-backup'    => false,
			'all_styles'     => false,
			'line-height'     => true,
